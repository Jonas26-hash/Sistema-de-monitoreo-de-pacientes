  ...
  return (
    <div>
      ...
      <Modal title={<Text style={{ color: 'var(--text-primary)', fontWeight: 600 }}>Nueva Dispensación</Text>}
        ...
        <Form form={form} layout="vertical" onFinish={(v) => createMutation.mutate({ ...v, fechaDispensacion: v.fechaDispensacion?.format?.('YYYY-MM-DD') ?? v.fechaDispensacion })} preserve={false}
          style={{ width: '100%' }}>
